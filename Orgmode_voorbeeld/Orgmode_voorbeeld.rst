...
.. table::
    ...
    +---------------------------------------------------------------------+------+
    | 2021-01\_\ :sub:`FOSSvsCommercieel.org`\                            | 2873 |
    +---------------------------------------------------------------------+------+
    | 2021-04\_\ :sub:`GentooLinux.org`\                                  | 4069 |
    +---------------------------------------------------------------------+------+
    | 2021-07\_\ :sub:`Ongedierte.org`\                                   | 3973 |
    +---------------------------------------------------------------------+------+
    | 2021-08\_\ :sub:`FOSSopScholen.org`\                                | 4908 |
    +---------------------------------------------------------------------+------+
    | 2021-10\_\ :sub:`TheWinMacLinuxExperience`\ \ :sub:`published.org`\ | 5063 |
    +---------------------------------------------------------------------+------+
    | 2021-12\_\ :sub:`Orgmode.org`\                                      | 4755 |
    +---------------------------------------------------------------------+------+
